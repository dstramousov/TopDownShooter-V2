...
### material_effects
Настройки визуальных частиц попадания по материалам. Это не debug-точки, а параметры
частиц, из которых рендер собирает короткий flash/debris/decal-эффект.
...
Минимально должен быть задан `default`.
