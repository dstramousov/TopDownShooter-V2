...
<img width="1308" height="786" alt="Screenshot from 2026-05-19 17-25-36" src="https://github.com/user-attachments/assets/d25e519b-2ff7-46ad-992b-38164ebcd005" />
...
Runtime UI использует общий шрифт для HUD, окна помощи по управлению и подтверждения выхода. Диагностическая панель удалена из runtime-петли, чтобы не тратить кадр на сбор и отрисовку большой отладочной панели.

Для тяжёлой debug-отрисовки врагов всё ещё есть отдельные лимиты. Отрисовка конусов обзора, путей и tactical slots может быть ограничена по количеству и дистанции до игрока, чтобы не просаживать FPS при большом числе активных врагов.
